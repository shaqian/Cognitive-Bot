  ...
  render() {
    return (
      <div>
        ...
        <button className="alert button language__button" onClick={this.stopRecord}>Stop Recording</button>
        :<button className="success button language__button" onClick={this.startRecord}>Start Recording</button>}
      </div>
    );
  }
  // render() {
